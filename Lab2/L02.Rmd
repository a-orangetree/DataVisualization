...
You should have already read chapters 1 and 2 in Hadley Wickham's *ggplot2: Elegant Graphics for Data Analysis*. The goal of this lab is to begin the process of actually unlocking the power of `ggplot2`. Through experimentation you should start to develop an understanding of `ggplot2` syntax and terminology.  
...
0b. Last week we imported data using the `read_csv()` function and this week we imported data using `read_delim()`. Why was that necessary? What's the difference between these functions?
