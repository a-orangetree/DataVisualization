...
The intent of this lab is to help students determine how well they actually know R. You should have already read chapters 1 and 2 in Hadley Wickham's *ggplot2: Elegant Graphics for Data Analysis*.
...
`1. Read the error. 2. Try to understand the error. 3. Copy and paste the error in Google.`
